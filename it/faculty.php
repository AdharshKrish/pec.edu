...
<body>
        ...
        <div class="container-dim container-fluid">
            <div class="row" id="row-top-margin">
                ...
                <div class="dept-name" id="dept-name">
                    ...
                    <h4 class="dept-name-text">Information Technology</h4>
    ...
    <main>
        ...
        $query = "SELECT l.id,l.email FROM login l INNER JOIN role r ON l.id=r.idref AND l.department='it' AND r.desg='HOD'";
        ...
        if (mysqli_num_rows($result)) {
         ...
         ?>
                <?php
                $query = "SELECT * FROM basic_faculty_info where post_tier='Professor' and department='it'";
            ...
            <a href="facultypage.php?email=' . $email . '">
                ...
                <?php
                $query = "SELECT * FROM basic_faculty_info where post_tier='Associate Professor' and department='it'";
            ...
            <div class="col-sm-6 col-md-6 col-lg-3 card-parent"><a href="facultypage.php?email=' . $email . '">
                ...
                <?php
                $query = "SELECT * FROM basic_faculty_info where post_tier='Assistant Professor' and department='it'";
                if ($result = mysqli_query($db_con, $query)) {
            ...
            <div class="col-sm-6 col-md-6 col-lg-3  card-parent"><a href="facultypage.php?email=' . $email . '">
                ...
                <?php
                $query = "SELECT * FROM basic_faculty_info where post_tier='Programmer' and department='it'";
                ...
                <?php
                $query = "SELECT * FROM basic_faculty_info where post_tier='Others' and department='it'";
            ...
            <?php            
            $query = "SELECT * FROM staff where dep='it'";
