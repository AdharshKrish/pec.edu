function menu(elt,item)
{
    ...
    if(item==='gallery'){
        ...
        document.getElementById('menu-col-3').innerHTML='<ul><li onclick="location.href=\'../home/campus-life.html\'" class="menu3">Campus Life</li><li class="menu3" onmouseover="menu1(this,1)">Committees<img src="../img/forward.svg" class="forward" alt=">"></li><li class="menu3" onmouseover="menu1(this,2)">Cells<img src="../img/forward.svg" class="forward" alt=">"></li><li class="menu3" onmouseover="menu1(this,3)">Clubs<img src="../img/forward.svg" class="forward" alt=">"></li><li class="menu3" onmouseover="menu1(this,4)">Chapters<img src="../img/forward.svg" class="forward" alt=">"></li><li class="menu3">Facilities</li></ul>';
        document.getElementById('menu-col-4').innerHTML='';
    }
...
function menu1(elt,index)
{
    ...
    if(index==1){
        document.getElementById('menu-col-4').innerHTML='<ul><li onclick="location.href=\'../home/CCC.php?id=Alumni%20Association\'">Alumni Association</li><li onclick="location.href=\'../home/CCC.php?id=Examination%20Wing\'">Examination Wing</li><li onclick="location.href=\'../home/CCC.php?id=Internal%20Complaints%20Committee\'">Internal Complaints Committee</li><li onclick="location.href=\'../home/CCC.php?id=National%20Cadet%20Corps\'">National Cadet Corps</li><li onclick="location.href=\'../home/CCC.php?id=National%20Service%20Scheme\'">National Service Scheme</li><li onclick="location.href=\'../home/CCC.php?id=Students%20Council\'">Students’ Council</li><li onclick="location.href=\'../home/CCC.php?id=Students%20Disciplinary%20Committee\'">Students’ Disciplinary Committee</li></ul>';
    }else if(index==2){
        document.getElementById('menu-col-4').innerHTML='<ul><li onclick="location.href=\'../home/CCC.php?id=Center%20for%20Continuing%20Education\'">Center for Continuing Education</li><li onclick="location.href=\'../home/CCC.php?id=Counselling%20and%20Career%20Guidance%20Cell\'">Counselling and Career Guidance Cell</li><li onclick="location.href=\'../home/CCC.php?id=Grievance%20Redressal%20Cell\'">Grievance Redressal Cell</li><li onclick="location.href=\'../home/CCC.php?id=Innovation%20and%20Entrepreneurship%20Development%20Cell\'">Innovation and Entrepreneurship Development Cell</li><li onclick="location.href=\'../home/CCC.php?id=Internal%20Quality%20Assurance%20Cell\'">Internal Quality Assurance Cell</li><li onclick="location.href=\'../home/CCC.php?id=IP%20Rights%20and%20Patenting%20Cell\'">IP Rights and Patenting Cell</li><li onclick="location.href=\'../home/CCC.php?id=SC-ST%20Cell\'">SC/ST Cell</li><li onclick="location.href=\'../home/CCC.php?id=Womens%20Cell\'">Womens’ Cell</li></ul>';
    }else if(index==3){
