...
$query1="INSERT INTO `basic_faculty_info`(`id`,`name`, `post_tier`, `contact_official_email`, `phno`, `extension`,  `qualification`, `specialization`,`dob`) VALUES ('".$fid."','".$name."','".$desg."','".$email."','".$contact."','".$ext."','".$qual."','".$special."','".$dob."');";
